...
def mock_authorize(email: str):
    ...
    """
    # This function directly generates tokens
    # without actual authentication for testing purposes.
...
def mock_authenticate():
    # This function simulates the authentication process
    # by directly mocking the authorization for a given email.
